...
const en: Translations = {
  ...
  home: {
    ...
    ctaTitle: "Ready to modernize your",
    ctaTitleHighlight: "IT?",
    ctaDesc: "Describe your context and we'll get back to you quickly with a clear, tailored proposal.",
    ctaBullets: ["Response within 24 business hours", "No-commitment quote", "Exclusive member services"],
    ctaMemberLabel: "Not yet a member?",
    ctaMemberDesc: "Join the Consortium and access exclusive IT services designed for the social economy.",
    ctaMemberBtn: "Become a member →",
    ctaFormTitle: "Request a quote",
    ctaFormOrg: "Organization name",
    ctaFormOrgPlaceholder: "Cooperative XYZ",
    ctaFormEmailPlaceholder: "contact@organization.ca",
    ctaFormService: "Service needed",
    ctaFormServiceDefault: "Choose a service…",
    ctaFormServices: [
      "Microsoft 365 Security",
      "Microsoft 365 Backup",
      "Proactive IT Management (RMM/EDR)",
    ...
    ctaFormMessage: "Message (optional)",
    ctaFormMessagePlaceholder: "Context, number of users, timeline, questions…",
    ctaFormSubmit: "Send request",
    whyLabel: "Why choose us",
    whyTitle: "IT services designed for",
    whyTitleHighlight: "your reality.",
    whyDesc: "The Consortium de coopération des entreprises collectives offers exclusive technology services to its members — cooperatives, mutuelles, and NPOs in Québec — at negotiated rates with personalized support.",
  ...
  backup: {
    ...
    statBanner: "60% of SMBs that suffer a major data loss never fully recover — CrashPlan, 2024",
  ...
  rmm: {
    ...
    statBanner: "Organizations adopting proactive IT management reduce tech expenses by 25–45% — Techaisle, 2024",
    introBullets: [
